...
public class OldPlayerInAirState : OldPlayerState
{
    //-----------INPUT-------------------
    private int xInput;
    ...
    public OldPlayerInAirState(Player player, OldPlayerStateMachine stateMachine, PlayerData playerData, string animationBoolName) : base(player, stateMachine, playerData, animationBoolName)
    {
    }
